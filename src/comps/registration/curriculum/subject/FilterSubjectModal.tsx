...
export default function FilterSubjectModal({
  ...
  return (
    ...
    >
      ...
      <form onSubmit={form.onSubmit(handleSubmit)} className="gap-2 flex flex-col" id="filter-subject-form">
         <Select
          id="select-filter-learning-area"
