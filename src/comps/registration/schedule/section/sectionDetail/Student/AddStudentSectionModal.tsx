...
import { IconSelector, IconUser, IconMail, IconPhone, IconId, IconLibrary, IconChalkboardTeacher } from '@tabler/icons-react';
...
export default function AddStudentSectionModal({
  ...
  return (
    <Modal
      ...
      size="md"
      radius={16}
      title={<Text fw={700} size="lg">เพิ่มนักเรียน</Text>} 
    >
